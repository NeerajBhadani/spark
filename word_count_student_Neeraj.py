...
wordCountsCollected = (wordsRDD
                       .map(lambda animal : (animal,1)).reduceByKey(lambda val1,val2 : val1+val2)
                       .collect())
...
def wordCount(wordListRDD):
    ...
    """
    return wordListRDD.map(lambda animal : (animal,1)).reduceByKey(lambda val1,val2 : val1 + val2)
...
# TODO: Replace <FILL IN> with appropriate code
shakespeareWordsRDD = shakespeareRDD.flatMap(lambda word : word.split(' '))
